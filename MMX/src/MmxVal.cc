...
char* MmxVal::IMPLE_CHAR_FUN(oString_i8) {
	snprintf(buf, sz, "%2d %2d %2d %2d %2d %2d %2d %2d", i8[0], i8[1], i8[2], i8[3], i8[4], i8[5], i8[6], i8[7]);
	buf[strlen(buf)] = '\0';
...
char* MmxVal::IMPLE_CHAR_FUN(oString_i16) {
	snprintf(buf, sz, "%4d %4d %4d %4d", i16[0], i16[1], i16[2], i16[3]);
	buf[strlen(buf)] = '\0';
...
char* MmxVal::IMPLE_CHAR_FUN(oString_i32) {
	snprintf(buf, sz, "%8d %8d", i32[0], i32[1]);
	buf[strlen(buf)] = '\0';
...
char* MmxVal::IMPLE_CHAR_FUN(oString_u8) {
	snprintf(buf, sz, "%2u %2u %2u %2u %2u %2u %2u %2u", u8[0], u8[1], u8[2], u8[3], u8[4], u8[5], u8[6], u8[7]);
	buf[strlen(buf)] = '\0';
...
char* MmxVal::IMPLE_CHAR_FUN(oString_u16) {
	snprintf(buf, sz, "%4u %4u %4u %4u", u16[0], u16[1], u16[2], u16[3]);
	buf[strlen(buf)] = '\0';
...
char* MmxVal::IMPLE_CHAR_FUN(oString_u32) {
	snprintf(buf, sz, "%8u %8u", u32[0], u32[1]);
	buf[strlen(buf)] = '\0';
